...
<div class="container-fluid">
    <ul class="full-box list-unstyled page-nav-tabs">
        ...
        <li>
            <a class="active" href="<?php echo SERVERURL;?>/itemList/"><i class="fas fa-clipboard-list fa-fw"></i> &nbsp; LISTA DE ITEMS</a>
        </li>
        <li>
        ...
        <table class="table table-dark table-sm">
            ...
            <tbody>
                <tr class="text-center" >
                    ...
                    <td>
                        <a href="<?php echo SERVERURL;?>/itemUpdate/" class="btn btn-success">
